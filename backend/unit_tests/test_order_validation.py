...
def test_sell_rejects_unowned_stock() -> None:
    available, error = sell_quantity_error(Decimal("0"), Decimal("0"), Decimal("1"))
...
def test_sell_reserves_quantity_for_pending_orders() -> None:
    available, error = sell_quantity_error(Decimal("10"), Decimal("7"), Decimal("4"))
...
def test_sell_accepts_available_quantity() -> None:
    available, error = sell_quantity_error(Decimal("10"), Decimal("3"), Decimal("7"))
