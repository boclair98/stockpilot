...
export default function TermsPage() {
  return <ServicePageShell eyebrow="TERMS" title="StockPilot 이용약관" description="안전한 가상투자 학습을 위해 꼭 필요한 기준을 안내합니다.">
    ...
    <section><h2>7. 플랜·결제</h2><p>플랜 안내 페이지의 Pro·Team 상품은 결제 연동 전 사전 등록 단계일 수 있습니다. 실제 결제를 시작할 때에는 결제 전 가격, 제공 기능, 해지·환불 조건을 별도로 안내하며, 결제 확인과 권한 부여는 검증된 서버 이벤트를 기준으로 처리합니다. 출시 알림 신청은 유료 구독이나 결제를 의미하지 않습니다.</p></section>
  </ServicePageShell>;
}
