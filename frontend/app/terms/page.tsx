...
export default function TermsPage() {
  return <ServicePageShell eyebrow="TERMS" title="StockPilot 이용약관" description="안전한 가상투자 학습을 위해 꼭 필요한 기준을 안내합니다.">
    ...
    <section><h2>4. 커뮤니티 기준</h2><p>라운지에 글을 게시하기 전에 이 약관과 커뮤니티 기준에 동의해야 합니다. 타인의 개인정보, 불법 정보, 수익을 보장하는 표현, 반복 광고 또는 시장 조작을 유도하는 내용을 게시할 수 없습니다. 이용자는 게시글에서 신고·차단 기능을 사용할 수 있으며, 운영자는 신고 내용을 검토해 글을 숨기거나 계정을 제한할 수 있습니다.</p></section>
    ...
    <section><h2>8. 광고</h2><p>무료 이용 화면에는 서비스 운영을 위한 광고가 표시될 수 있습니다. 광고는 매수·매도 주문, 로그인, 알림 설정과 같은 핵심 행동을 가리지 않도록 배치하며, 광고 클릭을 유도하거나 보상을 제공하지 않습니다.</p></section>
  </ServicePageShell>;
}
