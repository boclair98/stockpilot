...
import { BarChart3, BookOpen, Search, ShieldCheck, Trophy, WalletCards } from "lucide-react";
...
export default function GuidePage() {
  return (
    <ServicePageShell eyebrow="GETTING STARTED" title="StockPilot 이용 가이드" description="처음 방문해도 몇 분 안에 가상투자를 시작할 수 있도록 핵심 흐름을 정리했어요.">
      ...
      <section className="service-cta"><div><b>이제 직접 연습해 볼까요?</b><p>처음이라면 국내·미국 인기 종목을 살펴본 뒤 1주 가상 주문부터 시작해 보세요.</p></div><Link href="/">시장 둘러보기</Link></section>
    </ServicePageShell>
  );
}
