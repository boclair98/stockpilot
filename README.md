...
| 시장 탐색 | KRX·NXT·미국 TOP 종목, 최근 상승 종목 바로가기, 한국어 종목명·종목코드·티커 검색 |
| 가상주문 | 가격과 수량을 분리해 입력 중 시세 갱신 영향을 차단하고, 가상 체결·실거래 없음·수수료 반영을 주문 전 표시 |
| 주문 보호 | 미보유·보유 수량 초과 매도는 제출 전에 차단하며 오류 이유와 보유 가능 수량을 한국어로 안내 |
