...
| 주식 학습센터 | [열기](https://stockpilot.coders.kr/learn) | 12개 코스, 실제 시세 해설, 용어사전, 퀴즈, 계산기, 매수 전 체크리스트 |
...
- `1주`, `1개월`, `3개월` 기간 전환…3668 tokens truncated…코드 대신 바로 열 수 있는 `/league?invite=...` 링크 복사
